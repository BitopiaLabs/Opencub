...
import {
	...
	type VSCodeStatus,
} from '@/integrations/vscode/extension-installer';
import {defaultTheme, getThemeColors} from '@/shared/config/themes';
import {TIMEOUT_VSCODE_EXTENSION_SKIP_MS} from '@/shared/constants';
			...
			<Box flexDirection="column" paddingY={1}>
				...
				<Box marginTop={1}>
					<Text color={colors.text}>
						The VS Code extension enables live diff previews when OpenCub
						modifies files.
					</Text>
				</Box>
