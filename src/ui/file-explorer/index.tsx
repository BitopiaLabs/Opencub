...
import {getVSCodeServerSync} from '@/integrations/vscode/vscode-server';
import {
	CHARS_PER_TOKEN_ESTIMATE,
	FILE_EXPLORER_TOKEN_WARNING_THRESHOLD,
	FILE_EXPLORER_VISIBLE_ITEMS,
} from '@/shared/constants';
import type {FileExplorerProps, ViewMode} from '@/shared/types/file-explorer';
import {
	buildFileTree,
	type FileNode,
	flattenTree,
...
import {compressIndentation} from '@/shared/utils/indentation-normalizer';
import {StyledTitle} from '@/ui/primitives/styled-title';
