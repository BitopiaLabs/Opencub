...
import {isExtensionInstalled} from '@/integrations/vscode/extension-installer';
import {getAppConfig, loadDefaultMode} from '@/shared/config/index';
import {updateSelectedTheme} from '@/shared/config/preferences';
import {getThemeColors} from '@/shared/config/themes';
import {setCurrentMode as setCurrentModeContext} from '@/shared/context/mode-context';
import type {ThemePreset} from '@/shared/types/ui';
import {createPinoLogger} from '@/shared/utils/logging/pino-logger';
import {setGlobalMessageQueue} from '@/shared/utils/message-queue';
import {setNotificationsConfig} from '@/shared/utils/notifications';
import {getShutdownManager} from '@/shared/utils/shutdown';
import AssistantReasoning from '@/ui/assistant-reasoning';
...
import StreamingMessage from '@/ui/streaming-message';
import StreamingReasoning from '@/ui/streaming-reasoning';
import {
	shouldPromptExtensionInstall,
	VSCodeExtensionPrompt,
} from '@/ui/vscode-extension-prompt';
