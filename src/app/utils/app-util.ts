...
import type {LLMClient} from '@/shared/types/core';
import type {Message, MessageSubmissionOptions} from '@/shared/types/index';
...
import {ErrorMessage, InfoMessage, SuccessMessage} from '@/ui/message-box';
 ...
 * signature in `src/types` doesn't expose. They are registered in
 * `src/commands/` as stub handlers (so they appear in the slash menu and
 ...
 * `src/commands/` and register it in `src/commands/lazy-registry.ts`.
 */
