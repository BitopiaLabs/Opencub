...
import type {LLMClient, MCPConnectionStatus} from '@/shared/types/core';
import type {UpdateInfo} from '@/shared/types/utils';
import {
	generateCorrelationId,
	withNewCorrelationContext,
} from '@/shared/utils/logging';
import type {Logger} from '@/shared/utils/logging/types';
...
export function useAppLogging({
	...
	// Application startup
	useEffect(() => {
		logger.info('OpenCub application starting', {
			vscodeMode,
			vscodePort,
