...
test('Non-interactive mode: only exits when run command is used', t => {
	...
	//
	// This means:
	// - `opencub` - Normal interactive mode, no auto-exit (nonInteractivePrompt is undefined)
	// - `cub run "prompt"` - Non-interactive mode, auto-exits after completion
	// - `cub --vscode` - VS Code mode, no auto-exit (nonInteractivePrompt is undefined)
...
/**
 * Mirror of the --mode parser in `src/cli.tsx`. Kept in sync so tests
