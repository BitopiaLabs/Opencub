...
export function getVsixPath(): string {
	...
	const possiblePaths = [
		join(__dirname, '../../../assets/opencub-vscode.vsix'), // development (from src/integrations/vscode/)
		join(__dirname, '../../../../assets/opencub-vscode.vsix'), // npm installed (from dist/integrations/vscode/)
	];
...
/**
 * Check if the opencub VS Code extension is installed in any available VS Code flavor
