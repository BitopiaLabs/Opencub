...
import {jsonSchema} from '@/shared/types/index';
import {
...
import {
	...
	formatMemoryUsage,
	startMetrics,
} from '@/shared/utils/logging/performance.js';
import {getSafeMemory} from '@/shared/utils/logging/safe-process.js';
import {ensureString, isPlainObject} from '@/shared/utils/type-helpers';
	...
	getAllTools(): Tool[] {
		...
		for (const [serverName, serverTools] of this.serverTools.entries()) {
			...
			for (const mcpTool of serverTools) {
				// Convert MCP tool to opencub Tool format
