 ...
 *
 * Keeping this file flat and free of static command imports is how opencub
 ...
 * file under `src/commands/`. Keep the description in sync with the
 * module's own `description` field — they should match.
 */
import type {LazyCommand} from '@/shared/types/commands';
...
export const lazyCommands: LazyCommand[] = [
	...
	},
	{
		name: 'init',
		description:
			'Initialize opencub configuration and analyze project structure. Use --force to regenerate AGENTS.md.',
