...
import {parseMarkdown} from '@/shared/markdown-parser/index';
import type {Command} from '@/shared/types/index';
import {wrapWithTrimmedContinuations} from '@/shared/utils/text-wrapping';
			...
			{subagents.length === 0 ? (
				<>
					...
					<Text color={colors.secondary}>
						Create agents in{' '}
						<Text color={colors.primary}>.opencub/agents/</Text> or use{' '}
