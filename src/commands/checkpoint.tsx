...
import {addToMessageQueue} from '@/shared/utils/message-queue';
import {CheckpointListDisplay} from '@/ui/checkpoint-display';
import {
	ErrorMessage,
	InfoMessage,
	SuccessMessage,
...
Note: Checkpoints are stored in your opencub config directory.`}
			hideBox={false}
		/>
	);
}
...
async function loadCheckpoint(
  ...
  • Created: ${new Date(checkpointData.metadata.timestamp).toLocaleString()}`,
		...
		const CheckpointSelector = (await import('@/ui/checkpoint-selector'))
			.default;
