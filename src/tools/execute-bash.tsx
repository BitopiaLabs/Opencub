...
import {TRUNCATION_OUTPUT_LIMIT} from '@/shared/constants';
import {getCurrentMode} from '@/shared/context/mode-context';
import {
	type BashExecutionState,
	bashExecutor,
} from '@/shared/services/bash-executor';
...
const executeBashCoreTool = tool({
	...
	needsApproval: () => {
		...
		if (isOpenCubToolAlwaysAllowed('execute_bash')) {
			return false;
		}
...
export const executeBashTool: OpenCubToolExport = {
