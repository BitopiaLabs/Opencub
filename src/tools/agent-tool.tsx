...
import type {SubagentExecutor} from '@/features/subagents/subagent-executor.js';
import {getSubagentLoader} from '@/features/subagents/subagent-loader.js';
import {jsonSchema, tool} from '@/shared/types/core';
import type {OpenCubToolExport} from '@/shared/types/index';
...
export const agentTool: OpenCubToolExport = {
	name: 'agent',
	tool: agentCoreTool,
	readOnly: false,
};
