...
import {loadGitignore} from '@/shared/utils/gitignore-loader';
import {isValidFilePath, resolveFilePath} from '@/shared/utils/path-validation';
	...
	inputSchema: jsonSchema<ListDirectoryArgs>({
		...
		properties: {
			path: {
				type: 'string',
				description:
					'Directory path to list (default: "." current directory). Examples: ".", "src", "src/tools"',
			},
			recursive: {
				type: 'boolean',
				description:
...
export const listDirectoryTool: OpenCubToolExport = {
