...
import {DiagnosticSeverity, getLSPManager} from '@/integrations/lsp/index';
import {
	type DiagnosticInfo,
	getVSCodeServer,
} from '@/integrations/vscode/index';
import {TIMEOUT_LSP_DIAGNOSTICS_MS} from '@/shared/constants';
...
export const getDiagnosticsTool: OpenCubToolExport = {
