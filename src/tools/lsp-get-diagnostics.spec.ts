...
import type {DiagnosticInfo, DiagnosticSeverity as VSCodeDiagnosticSeverity} from '@/integrations/vscode/index';
import {DiagnosticSeverity} from '@/integrations/lsp/index';
...
- getVSCodeServer() from @/integrations/vscode/index
- getLSPManager() from @/integrations/lsp/index
