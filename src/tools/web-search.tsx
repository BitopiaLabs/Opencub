...
import {getBraveSearchApiKey} from '@/shared/config/opencub-tools-config';
import {
...
export const executeWebSearch = async (
	...
	if (!apiKey) {
		throw new Error(
			'Brave Search API key not configured. Add it to agents.config.json under opencubTools.webSearch.apiKey',
		);
	}
...
export const webSearchTool: OpenCubToolExport = {
