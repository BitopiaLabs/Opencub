...
} from '@/integrations/vscode/index';
import {DEFAULT_TERMINAL_COLUMNS} from '@/shared/constants';
import type {OpenCubToolExport} from '@/shared/types/core';
import {jsonSchema, tool} from '@/shared/types/core';
import {truncateAnsi} from '@/shared/utils/ansi-truncate';
import {getCachedFileContent, invalidateCache} from '@/shared/utils/file-cache';
import {normalizeIndentation} from '@/shared/utils/indentation-normalizer';
import {validatePath} from '@/shared/utils/path-validators';
import {getLanguageFromExtension} from '@/shared/utils/programming-language-helper';
import {calculateTokens} from '@/shared/utils/token-calculator';
import {createFileToolApproval} from '@/shared/utils/tool-approval';
import {ensureString} from '@/shared/utils/type-helpers';
import ToolMessage from '@/ui/tool-message';
...
export const writeFileTool: OpenCubToolExport = {
