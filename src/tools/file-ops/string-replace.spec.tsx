...
import {themes} from '@/shared/config/themes.js';
import {setCurrentMode} from '@/shared/context/mode-context.js';
...
test('string_replace validator: handles file read errors', async t => {
	...
	const originalCache = await import('@/shared/utils/file-cache.js');
