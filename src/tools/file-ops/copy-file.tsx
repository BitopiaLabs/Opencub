...
import {invalidateCache} from '@/shared/utils/file-cache';
import {validatePathPair} from '@/shared/utils/path-validators';
...
export const copyFileTool: OpenCubToolExport = {
