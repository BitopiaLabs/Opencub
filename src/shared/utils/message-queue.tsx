...
import {TIMEOUT_MESSAGE_PROCESSING_MS} from '@/shared/constants';
import type {MessageType} from '@/shared/types/index';
import {createErrorInfo} from '@/shared/utils/error-formatter';
