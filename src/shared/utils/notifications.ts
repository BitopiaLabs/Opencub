...
import {logInfo} from '@/shared/utils/message-queue';
...
> = {
	toolConfirmation: {
		...
		message: 'OpenCub is waiting for you to approve a tool call.',
	},
	questionPrompt: {
		title: `Question From Agent in ${projectName}`,
		message: 'OpenCub has a question and is waiting for your response.',
	},
	generationComplete: {
		title: `Response Ready in ${projectName}`,
		message: 'OpenCub has finished generating a response.',
	},
};
