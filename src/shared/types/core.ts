...
// Current OpenCub message format (OpenAI-compatible)
 ...
 */
export interface OpenCubToolExport {
	name: string;
...
export interface ModeOverrides {
	...
	modelParameters?: import('@/shared/types/config').ModelParameters;
}
