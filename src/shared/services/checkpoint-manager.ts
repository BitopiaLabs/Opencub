...
import {TRUNCATION_DESCRIPTION_LENGTH} from '@/shared/constants';
import type {
...
import {validateCheckpointName} from '@/shared/utils/checkpoint-utils';
 ...
 * Checkpoints are stored in .opencub/checkpoints/ within the workspace root.
 */
export class CheckpointManager {
	...
	constructor(workspaceRoot: string = process.cwd()) {
		// nosemgrep
		this.checkpointsDir = path.join(workspaceRoot, '.opencub', 'checkpoints'); // nosemgrep
