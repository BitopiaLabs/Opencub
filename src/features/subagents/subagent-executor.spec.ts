...
import {getModelContextLimit} from '@/llm/models';
import {SubagentLoader, getSubagentLoader} from './subagent-loader.js';
import type {ToolManager} from '@/tools/tool-manager';
import type {LLMClient, LLMChatResponse} from '@/shared/types/core';
import {setGlobalToolApprovalHandler} from '@/shared/utils/tool-approval-queue';
...
test.serial('tools needing approval are surfaced via signalToolApproval', async t => {
	...
	const {setGlobalToolApprovalHandler} = await import('@/shared/utils/tool-approval-queue.js');
...
test.serial('concurrent agents with agentId have isolated progress', async t => {
	...
	} = await import('@/shared/services/subagent-events.js');
