...
} from '@/features/init/existing-rules-extractor';
import type {ProjectAnalysis} from '@/features/init/project-analyzer';
import {THRESHOLD_LARGE_CODEBASE_FILES} from '@/shared/constants';
