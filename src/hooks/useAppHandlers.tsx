...
import type {Session} from '@/features/session/session-manager';
import {sessionManager} from '@/features/session/session-manager';
import {calculateTokenBreakdown} from '@/features/usage/calculator';
...
import {CheckpointManager} from '@/shared/services/checkpoint-manager';
...
import type {UpdateInfo} from '@/shared/types/utils';
import {autoCompactSessionOverrides} from '@/shared/utils/auto-compact';
import {getLogger} from '@/shared/utils/logging';
import {getLastBuiltPrompt} from '@/shared/utils/prompt-builder';
import type {Task} from '@/tools/tasks/types';
import {ErrorMessage, SuccessMessage, WarningMessage} from '@/ui/message-box';
...
interface UseAppHandlersProps {
	...
	currentProviderConfig:
		| import('@/shared/types/config').AIProviderConfig
		| null;
	currentModel: string;
