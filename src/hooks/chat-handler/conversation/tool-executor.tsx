...
import {MAX_CONCURRENT_AGENTS} from '@/features/subagents/subagent-executor';
import {
	clearAllSubagentProgress,
	getSubagentProgress,
	resetSubagentProgressById,
} from '@/shared/services/subagent-events';
import type {ToolCall, ToolResult} from '@/shared/types/core';
import {formatError} from '@/shared/utils/error-formatter';
import {parseToolArguments} from '@/shared/utils/tool-args-parser';
import {
	ALWAYS_EXPANDED_TOOLS,
	displayToolResult,
	LIVE_TASK_TOOLS,
} from '@/shared/utils/tool-result-display';
import type {AgentToolArgs} from '@/tools/agent-tool';
import {startAgentExecution} from '@/tools/agent-tool';
import type {ToolManager} from '@/tools/tool-manager';
import AgentProgress, {MultiAgentProgress} from '@/ui/agent-progress';
...
export const executeToolsDirectly = async (
	...
	const {processToolUse} = await import('@/shared/message-handler');
