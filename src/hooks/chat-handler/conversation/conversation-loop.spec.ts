...
import {clearAppConfig} from '@/shared/config/index.js';
import {resetShutdownManager} from '@/shared/utils/shutdown/shutdown-manager.js';
import {processAssistantResponse, resetFallbackNotice, resetLastTurnHadReasoning} from './conversation-loop.js';
import type {LLMChatResponse, Message, ToolCall, ToolResult} from '@/shared/types/core';
import {
	resetAutoCompactSession,
	setAutoCompactEnabled,
	setAutoCompactStrategy,
	setAutoCompactThreshold,
} from '@/shared/utils/auto-compact.js';
import {
	resetSessionContextLimit,
	setSessionContextLimit,
} from '@/llm/models/models-dev-client.js';

// The ShutdownManager singleton is created as a side effect of transitive
// imports (via @/shared/utils/logging). Its uncaughtException/unhandledRejection
