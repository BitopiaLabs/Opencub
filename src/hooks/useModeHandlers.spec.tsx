...
// `~/Library/Preferences/opencub/opencub-preferences.json`.
process.env.OPENCUB_CONFIG_DIR = mkdtempSync(
	join(tmpdir(), 'opencub-spec-'),
);
const {resetPreferencesCache} = await import('@/shared/config/preferences');
