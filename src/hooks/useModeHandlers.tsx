...
import {reloadAppConfig} from '@/shared/config/index';
import {saveTune, updateLastUsed} from '@/shared/config/preferences';
import {getToolManager} from '@/shared/message-handler';
import type {AIProviderConfig, TuneConfig} from '@/shared/types/config';
import {LLMClient, Message} from '@/shared/types/core';
import {
	setAutoCompactMode,
