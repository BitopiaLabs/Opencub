...
import {
	TIMEOUT_HTTP_BODY_MS,
	TIMEOUT_HTTP_HEADERS_MS,
} from '@/shared/constants';
import type {AIProviderConfig, ProviderConfig} from '@/shared/types/config';
 ...
 * 4. OPENCUB_CONTEXT_LIMIT env variable
...
export async function resolveModelContextLimit(
	...
	try {
		...
		const envLimit = process.env.OPENCUB_CONTEXT_LIMIT;
		if (envLimit) {
