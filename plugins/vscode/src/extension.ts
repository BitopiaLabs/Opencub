...
export function activate(context: vscode.ExtensionContext) {
	...
	outputChannel.appendLine('OpenCub extension activating...');
	...
	statusBarItem.command = 'opencub.connect';
	...
	outputChannel.appendLine('OpenCub extension activated');
}
...
function updateStatusBar(connected: boolean, text?: string): void {
	if (text) {
		...
		statusBarItem.text = '$(check) OpenCub';
		statusBarItem.tooltip = 'Connected to OpenCub CLI';
		statusBarItem.command = 'opencub.disconnect';
	} else {
		statusBarItem.text = '$(plug) OpenCub';
		statusBarItem.tooltip = 'Click to connect to OpenCub CLI';
		statusBarItem.command = 'opencub.connect';
	}
}
